...
import {
  ...
  CSV_FIELDS,
  EMPTY_DRAFT,
  computeDraftFromParams,
  draftsEqual,
  toggleCsvValue,
  type NumericField,
  type CsvField,
  type FilterDraft,
} from "@/lib/vehicle-filter-draft";

// Re-exported so existing imports of these pure helpers from this module
// keep working — the canonical definitions now live in vehicle-filter-draft.ts
// (a plain, non-"use client" module) so a Server Component can call them too.
export { NUMERIC_FIELDS, CSV_FIELDS, EMPTY_DRAFT, computeDraftFromParams, draftsEqual, toggleCsvValue };
export type { NumericField, CsvField, FilterDraft };
