...
// entirely normal, and the browser legitimately cancels (net::ERR_ABORTED)
// a prefetch that's no longer needed (link scrolled away, page navigated).
// That is not a broken request; only a genuinely failed/aborted *primary*
// navigation or data request should fail a test.
